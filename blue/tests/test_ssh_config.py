...
def test_the_bare_profile_plus_stable_node_aliases():
    assert sc.aliases(opts) == ['langfuse-test', 'langfuse-test-neon-0', 'langfuse-test-redis-0',
        'langfuse-test-clickhouse-0', 'langfuse-test-clickhouse-1', 'langfuse-test-clickhouse-2', 'langfuse-test-app-0']
    assert sc.identity_file(opts) == '~/.ssh/langfuse-test'
    assert sc.machine_alias({**opts, 'vultr-name': 'custom'}, {'node_id': 'app-0'}) == 'langfuse-test-app-0'
