...
resource "vultr_vpc" "langfuse" {
  region         = "ams"
  description    = "langfuse-optout-fixture"
...
resource "vultr_firewall_group" "app" {
  description = "langfuse-optout-fixture-app-firewall"
}
resource "vultr_firewall_group" "neon" {
  description = "langfuse-optout-fixture-neon-firewall"
}
resource "vultr_firewall_group" "redis" {
  description = "langfuse-optout-fixture-redis-firewall"
}
resource "vultr_firewall_group" "clickhouse" {
  description = "langfuse-optout-fixture-clickhouse-firewall"
}
...
resource "vultr_instance" "neon" {
  label             = "langfuse-optout-fixture-neon"
  region            = "ams"
  plan              = "vc2-4c-8gb"
  os_id             = 2284
  firewall_group_id = vultr_firewall_group.neon.id
...
resource "vultr_instance" "redis" {
  label             = "langfuse-optout-fixture-redis"
  region            = "ams"
  plan              = "vc2-1c-2gb"
  os_id             = 2284
  firewall_group_id = vultr_firewall_group.redis.id
...
resource "vultr_instance" "clickhouse" {
  ...
  label             = "langfuse-optout-fixture-clickhouse-${count.index}"
  region            = "ams"
  plan              = "vc2-4c-8gb"
  os_id             = 2284
  firewall_group_id = vultr_firewall_group.clickhouse.id
...
resource "vultr_instance" "app" {
  label             = "langfuse-optout-fixture-app"
  region            = "ams"
  plan              = "vc2-4c-8gb"
  os_id             = 2284
  firewall_group_id = vultr_firewall_group.app.id
